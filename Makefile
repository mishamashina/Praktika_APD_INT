#############################################################################
# Makefile for building: APD_Interface
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  APD_Interface.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile APD_Interface.pro
#############################################################################
...
INCPATH       = -I. -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtNetwork -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I. -I. -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = APD_Interface1.0.0
DISTDIR = /home/praktik/Рабочий\ стол/QtProject/APD_Interface/.tmp/APD_Interface1.0.0
LINK          = g++
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		udpsocket.cpp moc_mainwindow.cpp \
		moc_udpsocket.cpp
OBJECTS       = main.o \
		mainwindow.o \
		udpsocket.o \
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		APD_Interface.pro mainwindow.h \
		udpsocket.h main.cpp \
		mainwindow.cpp \
		udpsocket.cpp
QMAKE_TARGET  = APD_Interface
DESTDIR       = 
TARGET        = APD_Interface


first: all
####### Build rules

APD_Interface: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: APD_Interface.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile APD_Interface.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h udpsocket.h $(DISTDIR)/
	$(COPY_FILE) --parents datagram.cpp main.cpp mainwindow.cpp udpsocket.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_udpsocket.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_udpsocket.cpp
moc_mainwindow.cpp: mainwindow.h \
		udpsocket.h \
		datagram.cpp \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include '/home/praktik/Рабочий стол/QtProject/APD_Interface/moc_predefs.h' -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I'/home/praktik/Рабочий стол/QtProject/APD_Interface' -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtNetwork -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/12 -I/usr/include/x86_64-linux-gnu/c++/12 -I/usr/include/c++/12/backward -I/usr/lib/gcc/x86_64-linux-gnu/12/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include mainwindow.h -o moc_mainwindow.cpp

moc_udpsocket.cpp: udpsocket.h \
		datagram.cpp \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include '/home/praktik/Рабочий стол/QtProject/APD_Interface/moc_predefs.h' -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I'/home/praktik/Рабочий стол/QtProject/APD_Interface' -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtNetwork -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/12 -I/usr/include/x86_64-linux-gnu/c++/12 -I/usr/include/c++/12/backward -I/usr/lib/gcc/x86_64-linux-gnu/12/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include udpsocket.h -o moc_udpsocket.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/APD_Interface/bin || mkdir -p $(INSTALL_ROOT)/opt/APD_Interface/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/APD_Interface/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/APD_Interface/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/APD_Interface/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/APD_Interface/bin/ 
